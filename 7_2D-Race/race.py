...
# Load images
car_img = pygame.image.load('7_2D-Race\car.png')
...
def game_loop():
    ...
    while running:
        ...
        if random.randint(1, 30) == 1:  # Adjusted obstacle frequency
    ...
    pygame.display.flip()
    pygame.time.wait(5000)  # Display final screen for 5 seconds
